...
import { Scale, GraduationCap, Users, BookOpen, School, Venus, Mars } from 'lucide-react';
...
export default function DiagnosticPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden selection:bg-primary/30 flex flex-col items-center w-full" dir="rtl">
      {/* Decorative Elements */}
